  ...
  render() {
    return (
      <PostsContainer>
        ...
        <div>
          {this.props.posts.allMarkdownRemark.edges
  ...
  return (
    <Layout>
      ...
      <Wrapper>
        ...
        <About>
          I'm a software developer based in Brasilia, Brasil. You can find me at{" "}
          <a href="https://github.com/vinicius0197">Github</a> and check my
          thoughts here at this blog.
        </About>
      </Wrapper>
